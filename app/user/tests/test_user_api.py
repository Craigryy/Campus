...
# Function to get the user model dynamically
...
# URL for retrieving/updating the authenticated user
...
class PublicUserApiTests(TestCase):
    ...
    def test_create_user_success(self):
        ...
        self.assertEqual(
            res.status_code,
            status.HTTP_201_CREATED)  # Expect a 201 response
    ...
    def test_user_with_email_exists_error(self):
        ...
        self.assertEqual(
            res.status_code,
            status.HTTP_400_BAD_REQUEST)  # Expect a 400 error
    ...
    def test_create_token_bad_credentials(self):
        ...
        payload = {'email': 'test@example.com',
                   'password': 'badpass'}  # Incorrect password
        res = self.client.post(TOKEN_URL, payload)
    ...
    def test_retrieve_user_unauthorized(self):
        ...
        self.assertEqual(
            res.status_code,
            status.HTTP_401_UNAUTHORIZED)  # Expect a 401 error
...
class PrivateUserApiTests(TestCase):
    ...
    def setUp(self):
        ...
        self.client.force_authenticate(
            user=self.user)  # Authenticate the test client
    ...
    def test_post_me_not_allowed(self):
        ...
        self.assertEqual(
            res.status_code,
            status.HTTP_405_METHOD_NOT_ALLOWED)  # Expect a 405 error
    ...
    def test_update_user_profile(self):
        ...
        # Ensure password is updated securely
